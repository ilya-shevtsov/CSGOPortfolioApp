...
@Composable
private fun PortfolioPortraitContent(
    state: PortfolioViewState.Content,
    onAction: (PortfolioAction) -> Unit,
    listState: LazyListState,
    modifier: Modifier = Modifier
...
@Composable
private fun PortfolioValueHeader(
...
@Composable
fun PortfolioScreenPortraitPreview() {
    PortfolioScreenPreviewContent(
        deviceConfigurationType = DeviceConfigurationType.MOBILE_PORTRAIT
    )
}

@Preview(
    name = "Portfolio - landscape light",
    showBackground = true,
    widthDp = 900,
    heightDp = 420,
    uiMode = android.content.res.Configuration.UI_MODE_NIGHT_NO
...
@Composable
fun PortfolioScreenLandscapePreview() {
    PortfolioScreenPreviewContent(
...
@Composable
private fun PortfolioScreenPreviewContent(
    deviceConfigurationType: DeviceConfigurationType
) {
    AppTheme {
        ...
        PortfolioScreen(
            state = PortfolioViewState.Content(
                ...
                portfolioItemModelList = previewPortfolioItems()
            ),
            onAction = {},
            listState = listState,
            deviceConfigurationType = deviceConfigurationType
...
private fun previewPortfolioItems(): List<PortfolioItemModel> {
    return listOf(
        PortfolioItemModel(
            itemImage = "",
